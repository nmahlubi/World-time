...
class _ChooseLocationState extends State<ChooseLocation> {
  ...
  List<WorldTime> locations =[
    ...
    WorldTime(url: 'Africa/SouthAfrica' , location: 'South Africa', flag: 'sa.png'),
    ...
    WorldTime(url: 'Asia/Seoul' , location: 'Seoul', flag: 'asiaSeoul.png'),
    WorldTime(url: 'Asia/Jakarta' , location: 'Jakarta', flag: 'asiaJakarta.jpg'),
  ];
